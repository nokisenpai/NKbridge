...
public class AddToGroup implements SubCommand
{
	public AddToGroup()
	{
	...
	public boolean execute(CommandSender sender, String[] args)
	{
		if(args.length == 2)
		{
			sender.sendMessage(Usages.ROOT_GROUP_ADD_WORLD_CMD.toString());
		...
		if(sender instanceof Player)
		{
			if(args.length >= 3)
			{
				...
				{
					MessageParser messageParser = new MessageParser(Messages.ALREADY_IN_SPECIFIED_GROUP.toString());
				...
				{
					MessageParser messageParser = new MessageParser(Messages.ALREADY_IN_GROUP.toString());
					messageParser.addArg(worldName);
				...
				AsyncQueueManager.addToQueue(o ->
				{
					...
					MessageParser messageParser = new MessageParser(Messages.ADDED_IN_GROUP.toString());
