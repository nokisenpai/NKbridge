...
public class RemoveFromGroup
{
	...
	public RemoveFromGroup(GroupManager groupManager, QueueManager queueManager, InventoryManager inventoryManager)
	{
	...
	public boolean removeFromGroup(CommandSender sender, String[] args)
	{
		// If no more argument
		if(args.length == 2)
		{
			sender.sendMessage(ChatColor.GREEN + "/bridge group removeworld <groupName> [worldName]");
			return true;
		}
		...
		if(sender instanceof Player)
		{
			if(args.length >= 3)
			{
				...
				{
					sender.sendMessage(ChatColor.RED + "Le monde '" + worldName + "' n'est pas dans le groupe '" + args[2] + "'.");
					return true;
				}
				...
				queueManager.addToQueue(new Function()
				{
					...
					public Object apply(Object o)
					{
						...
						sender.sendMessage(ChatColor.GREEN + "Le monde '" + finalWorldName + "' a été retiré du groupe '" + args[2] + "'.");
						return null;
					}
				});
			}
